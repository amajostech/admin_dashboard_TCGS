        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                if(isset($_GET['session']) && isset($_GET['term'])){
                    ...
                    $fetch = mysqli_query($link, " SELECT * FROM subjects WHERE category = '$stud_cat' && school_id='$adminschid' ");
                    ...
                    foreach ($fetch as $f) {
                        ...
                        echo "<tr> <td> $subject </td> 
                         <td>              
                          <form action='displayresultsub.php'>
                           ...
                           <input type='' hidden='' class='' name='subject' value='$subject'>
