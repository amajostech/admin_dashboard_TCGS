            ...
            <div class="col-sm-12">
                ...
                <div class="col-12">
                    ...
                    if (isset($_GET['name'])) {
                        ...
                        $fetch = mysqli_query($link, "SELECT * FROM resultdata WHERE student='$stud_nm' && session='$stud_sess' && class='$stud_cla' && term='$stud_trm' && school_id='$adminschid' && category='$stud_cat' ");
