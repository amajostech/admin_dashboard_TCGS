...
echo "<td>$rsub</td>
  ...
  echo "<tr> 
       <td style='center; color: blue; '> TOTAL </td> 
	   ...
	   <td style='text-align: center; color: red; '> $sumexam </td>
	   <td style='text-align: center; color: red; '> $rtot </td>
	   ";
...
<div class='container'>
   <div class='row'>
     <table class="table table-inline" style='font-size: 14t;'>
		<?php 
		echo "
